...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, A, B, C, k=256, l=256, m=384, n=384, embedding_size = 256,class_nums=100):
        super().__init__()
...
def inception_resnet_v2(embedding_size):
    return InceptionResNetV2(5, 10, 5,embedding_size)
